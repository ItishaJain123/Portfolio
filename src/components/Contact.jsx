...
//               <div className="flex items-start space-x-4 p-4 bg-blue-50 border border-blue-100 rounded-lg shadow">
...
//                   <p className="text-sm text-slate-600">+91 8619695078</p>
//                 </div>
//               </div>
...
//           {/* Contact Form */}
//           <div className="bg-blue-50 border border-blue-100 rounded-xl shadow-lg p-8 relative">
