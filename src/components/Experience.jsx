...
const Experience = () => {
  ...
  return (
    <section id="experience" className="py-15 bg-white transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl text-slate-600 mx-auto">
            A glimpse into the professional path and educational foundation that shaped my passion
            for building beautiful, user-centered interfaces.
          </p>
        </div>
                ...
                <div key={index} className="relative">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1 bg-white shadow-md rounded-xl p-6 border border-slate-100 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-xl hover:ring-2 hover:ring-[#2563EB]/30 cursor-pointer">
                      ...
                      <div className="text-[#2563EB] font-semibold mb-1">{exp.company}</div>
              ...
              {education.map((edu, index) => (
                <div
                  ...
                  className={`p-6 rounded-xl transition-all duration-300 transform hover:scale-[1.02] hover:shadow-xl hover:ring-2 hover:ring-[#2563EB]/30 shadow-md border cursor-pointer ${
                    edu.highlight ? "bg-blue-50 border-blue-200" : "bg-white border-slate-200"
                  }`}
                >
                  ...
                  <div className="text-[#2563EB] font-semibold mb-1">{edu.institution}</div>
